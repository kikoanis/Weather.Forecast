...
using Weather.Forecast.Core.ProjectAggregate;
using Weather.Forecast.Core.ProjectAggregate.Events;
using Weather.Forecast.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace Weather.Forecast.UnitTests.Core.Handlers;
